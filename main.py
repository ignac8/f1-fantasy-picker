...
def budget_filter(combination, budget, required_drivers):
...
if __name__ == '__main__':
    ...
    required_drivers = ['Verstappen', 'Leclerc']
    ...
    possible_combinations = filter(lambda x: budget_filter(x, budget, required_drivers), all_combinations)
